...
_DATA	SEGMENT
$SG44197 DB	'1.2.13.1-motley', 00H
$SG44588 DB	'invalid block type', 00H
	ORG $+1
$SG44593 DB	'invalid stored block lengths', 00H
	ORG $+3
$SG44605 DB	'too many length or distance symbols', 00H
$SG44609 DB	'invalid code lengths set', 00H
	ORG $+3
$SG44620 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG44628 DB	'invalid bit length repeat', 00H
	ORG $+2
$SG44631 DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG44633 DB	'invalid literal/lengths set', 00H
$SG44635 DB	'invalid distances set', 00H
	ORG $+2
$SG44651 DB	'invalid literal/length code', 00H
$SG44663 DB	'invalid distance code', 00H
	ORG $+2
$SG44668 DB	'invalid distance too far back', 00H
_DATA	ENDS
...
; 30   :     if (version == Z_NULL || version[0] != ZLIB_VERSION[0] ||
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	ecx, BYTE PTR $SG44197[edx]
	cmp	eax, ecx
...
; 307  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44588
...
; 318  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44593
...
; 356  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44605
...
; 378  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44609
...
; 401  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44620
...
; 424  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44628
...
; 438  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44631
...
; 452  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44633
...
; 461  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG44635
...
; 520  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44651
...
; 552  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44663
...
; 567  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG44668
