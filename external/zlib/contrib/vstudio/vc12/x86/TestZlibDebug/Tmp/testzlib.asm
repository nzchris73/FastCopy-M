...
$SG100613 DB	'rb', 00H
	ORG $+5
$SG100674 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG100677 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG100678 DB	'file %s read, %u bytes', 0aH, 00H
$SG100682 DB	'1.2.13.1-motley', 00H
$SG100683 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG100684 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG100685 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG100686 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG100687 DB	'1.2.13.1-motley', 00H
$SG100688 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG100689 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG100690 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG100691 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG100694 DB	'compare ok', 0aH, 00H
_DATA	ENDS
