; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	C:\Users\chris\Documents\GitHub\FastCopy-M\external\zlib\contrib\vstudio\vc12\x86\TestZlibDebug\Tmp\testzlib.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG101370 DB	'rb', 00H
	ORG $+5
$SG101431 DB	'run TestZlib <File> [BlockSizeCompress] [BlockSizeUncomp'
	DB	'ress] [compres. level]', 0aH, 00H
$SG101434 DB	'error reading %s', 0aH, 00H
	ORG $+2
$SG101435 DB	'file %s read, %ld bytes', 0aH, 00H
	ORG $+3
$SG101439 DB	'1.2.13.1-motley', 00H
$SG101440 DB	'total compress size = %u, in %u step', 0aH, 00H
	ORG $+2
$SG101441 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG101442 DB	'defcpr time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG101443 DB	'defcpr result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG101444 DB	'1.2.13.1-motley', 00H
$SG101445 DB	'total uncompress size = %u, in %u step', 0aH, 00H
$SG101446 DB	'time = %u msec = %f sec', 0aH, 00H
	ORG $+3
$SG101447 DB	'uncpr  time QP = %u msec = %f sec', 0aH, 00H
	ORG $+1
$SG101448 DB	'uncpr  result rdtsc = %I64x', 0aH, 0aH, 00H
	ORG $+2
$SG101451 DB	'compare ok', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File C:\Users\chris\Documents\GitHub\FastCopy-M\external\zlib\contrib\testzlib\testzlib.c
_TEXT	SEGMENT
_zcpr$1 = -260						; size = 56
_zcpr$2 = -204						; size = 56
...
; 1042 :     __asm    {
; 1043 :         mov     ecx, ShiftCount

	mov	ecx, DWORD PTR _ShiftCount$[ebp]

; 1044 :         mov     eax, dword ptr [Value]

	mov	eax, DWORD PTR _Value$[ebp]

; 1045 :         mov     edx, dword ptr [Value+4]
