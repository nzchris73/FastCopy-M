; Listing generated by Microsoft (R) Optimizing Compiler Version 19.36.32537.0 
	...
	TITLE	C:\Users\chris\Documents\GitHub\FastCopy-M\external\zlib\contrib\vstudio\vc12\x86\TestZlibDebug\Tmp\crc32.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File C:\Users\chris\Documents\GitHub\FastCopy-M\external\zlib\crc32.c
_TEXT	SEGMENT
_len2$ = 8						; size = 8
_crc32_combine_gen64@8 PROC
...
; 686  :         data = (data << 8) ^
	...
	xor	ecx, DWORD PTR _crc_big_table[edx*4]
	mov	DWORD PTR _data$[ebp], ecx
	jmp	SHORT $LN2@crc_word_b
$LN3@crc_word_b:
...
; 679  :         data = (data >> 8) ^ crc_table[data & 0xff];
	...
	mov	edx, DWORD PTR _data$[ebp]
	and	edx, 255				; 000000ffH
	xor	ecx, DWORD PTR _crc_table[edx*4]
	mov	DWORD PTR _data$[ebp], ecx
	jmp	SHORT $LN2@crc_word
$LN3@crc_word:
...
; 179  :     p = (z_crc_t)1 << 31;           /* x^0 == 1 */
	...
	mov	DWORD PTR _p$[ebp], -2147483648		; 80000000H
$LN2@x2nmodp:
...
; 181  :         if (n & 1)
	...
	or	eax, DWORD PTR tv82[ebp+4]
	je	SHORT $LN4@x2nmodp
...
; 182  :             p = multmodp(x2n_table[k & 31], p);
	...
	mov	eax, DWORD PTR _x2n_table[edx*4]
	push	eax
	call	_multmodp
	add	esp, 8
...
; 158  :     m = (z_crc_t)1 << 31;
	...
	mov	DWORD PTR _m$[ebp], -2147483648		; 80000000H
...
; 161  :         if (a & m) {
	...
	and	eax, DWORD PTR _m$[ebp]
	je	SHORT $LN5@multmodp
...
; 163  :             if ((a & (m - 1)) == 0)
	...
	jne	SHORT $LN5@multmodp

; 164  :                 break;

	jmp	SHORT $LN3@multmodp
$LN5@multmodp:
...
; 167  :         b = b & 1 ? (b >> 1) ^ POLY : b >> 1;
	...
	and	ecx, 1
	je	SHORT $LN8@multmodp
	mov	edx, DWORD PTR _b$[ebp]
	shr	edx, 1
	xor	edx, -306674912				; edb88320H
	mov	DWORD PTR tv76[ebp], edx
	jmp	SHORT $LN9@multmodp
$LN8@multmodp:
...
; 709  :     if (len >= N * W + W - 1) {
	...
	cmp	DWORD PTR _len$[ebp], 23		; 00000017H
	jb	$LN14@crc32_z
$LN2@crc32_z:
...
; 722  :         blks = len / (N * W);
	...
	div	ecx
	mov	DWORD PTR _blks$22[ebp], eax

; 723  :         len -= blks * N * W;

	imul	edx, DWORD PTR _blks$22[ebp], 5
	shl	edx, 2
	mov	eax, DWORD PTR _len$[ebp]
	sub	eax, edx
...
; 724  :         words = (z_word_t const *)buf;
	...
	mov	ecx, DWORD PTR _buf$[ebp]
	mov	DWORD PTR _words$25[ebp], ecx
...
; 731  :         if (*(unsigned char *)&endian) {
	...
	movzx	edx, BYTE PTR _endian$1[ebp]
	test	edx, edx
	je	$LN20@crc32_z
...
; 758  :             crc0 = crc;
	...
	mov	eax, DWORD PTR _crc$[ebp]
	mov	DWORD PTR _crc0$21[ebp], eax

; 759  : #if N > 1
; 760  :             crc1 = 0;

	mov	DWORD PTR _crc1$20[ebp], 0

; 761  : #if N > 2
; 762  :             crc2 = 0;

	mov	DWORD PTR _crc2$19[ebp], 0

; 763  : #if N > 3
; 764  :             crc3 = 0;

	mov	DWORD PTR _crc3$18[ebp], 0

; 765  : #if N > 4
; 766  :             crc4 = 0;

	mov	DWORD PTR _crc4$17[ebp], 0
$LN4@crc32_z:
...
; 779  :             while (--blks) {
	...
	mov	ecx, DWORD PTR _blks$22[ebp]
	sub	ecx, 1
	mov	DWORD PTR _blks$22[ebp], ecx
	je	$LN5@crc32_z
...
; 781  :                 word0 = crc0 ^ words[0];
	...
	mov	edx, 4
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc0$21[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	mov	DWORD PTR _word0$11[ebp], edx
...
; 783  :                 word1 = crc1 ^ words[1];
	...
	shl	eax, 0
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc1$20[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	mov	DWORD PTR _word1$10[ebp], edx
...
; 785  :                 word2 = crc2 ^ words[2];
	...
	shl	eax, 1
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc2$19[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	mov	DWORD PTR _word2$9[ebp], edx
...
; 787  :                 word3 = crc3 ^ words[3];
	...
	mov	eax, 4
	imul	ecx, eax, 3
	mov	edx, DWORD PTR _words$25[ebp]
	mov	eax, DWORD PTR _crc3$18[ebp]
	xor	eax, DWORD PTR [edx+ecx]
	mov	DWORD PTR _word3$8[ebp], eax
...
; 789  :                 word4 = crc4 ^ words[4];
	...
	shl	ecx, 2
	mov	edx, DWORD PTR _words$25[ebp]
	mov	eax, DWORD PTR _crc4$17[ebp]
	xor	eax, DWORD PTR [edx+ecx]
	mov	DWORD PTR _word4$7[ebp], eax
...
; 801  :                 crc0 = crc_braid_table[0][word0 & 0xff];
	...
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _word0$11[ebp]
	and	ecx, 255				; 000000ffH
	mov	edx, DWORD PTR _crc_braid_table[eax+ecx*4]
	mov	DWORD PTR _crc0$21[ebp], edx
...
; 803  :                 crc1 = crc_braid_table[0][word1 & 0xff];
	...
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _word1$10[ebp]
	and	edx, 255				; 000000ffH
	mov	eax, DWORD PTR _crc_braid_table[ecx+edx*4]
	mov	DWORD PTR _crc1$20[ebp], eax
...
; 805  :                 crc2 = crc_braid_table[0][word2 & 0xff];
	...
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _word2$9[ebp]
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc_braid_table[edx+eax*4]
	mov	DWORD PTR _crc2$19[ebp], ecx
...
; 807  :                 crc3 = crc_braid_table[0][word3 & 0xff];
	...
	mov	edx, 1024				; 00000400H
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _word3$8[ebp]
	and	ecx, 255				; 000000ffH
	mov	edx, DWORD PTR _crc_braid_table[eax+ecx*4]
	mov	DWORD PTR _crc3$18[ebp], edx
...
; 809  :                 crc4 = crc_braid_table[0][word4 & 0xff];
	...
	mov	eax, 1024				; 00000400H
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _word4$7[ebp]
	and	edx, 255				; 000000ffH
	mov	eax, DWORD PTR _crc_braid_table[ecx+edx*4]
	mov	DWORD PTR _crc4$17[ebp], eax
...
; 818  :                     crc0 ^= crc_braid_table[k][(word0 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word0$11[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc0$21[ebp]
	xor	ecx, DWORD PTR _crc_braid_table[edx+eax*4]
	mov	DWORD PTR _crc0$21[ebp], ecx
...
; 820  :                     crc1 ^= crc_braid_table[k][(word1 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word1$10[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc1$20[ebp]
	xor	ecx, DWORD PTR _crc_braid_table[edx+eax*4]
	mov	DWORD PTR _crc1$20[ebp], ecx
...
; 822  :                     crc2 ^= crc_braid_table[k][(word2 >> (k << 3)) & 0xff];
	...
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc2$19[ebp]
	xor	ecx, DWORD PTR _crc_braid_table[edx+eax*4]
	mov	DWORD PTR _crc2$19[ebp], ecx
...
; 824  :                     crc3 ^= crc_braid_table[k][(word3 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word3$8[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc3$18[ebp]
	xor	ecx, DWORD PTR _crc_braid_table[edx+eax*4]
	mov	DWORD PTR _crc3$18[ebp], ecx
...
; 826  :                     crc4 ^= crc_braid_table[k][(word4 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word4$7[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc4$17[ebp]
	xor	ecx, DWORD PTR _crc_braid_table[edx+eax*4]
	mov	DWORD PTR _crc4$17[ebp], ecx
...
; 880  :             crc0 = byte_swap(crc);
	...
	call	_byte_swap
	add	esp, 4
	mov	DWORD PTR _crc0$16[ebp], eax

; 881  : #if N > 1
; 882  :             crc1 = 0;

	mov	DWORD PTR _crc1$15[ebp], 0

; 883  : #if N > 2
; 884  :             crc2 = 0;

	mov	DWORD PTR _crc2$14[ebp], 0

; 885  : #if N > 3
; 886  :             crc3 = 0;

	mov	DWORD PTR _crc3$13[ebp], 0

; 887  : #if N > 4
; 888  :             crc4 = 0;

	mov	DWORD PTR _crc4$12[ebp], 0
$LN9@crc32_z:
...
; 901  :             while (--blks) {
	...
	mov	eax, DWORD PTR _blks$22[ebp]
	sub	eax, 1
	mov	DWORD PTR _blks$22[ebp], eax
	je	$LN10@crc32_z
...
; 903  :                 word0 = crc0 ^ words[0];
	...
	mov	ecx, 4
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _words$25[ebp]
	mov	ecx, DWORD PTR _crc0$16[ebp]
	xor	ecx, DWORD PTR [eax+edx]
	mov	DWORD PTR _word0$6[ebp], ecx
...
; 905  :                 word1 = crc1 ^ words[1];
	...
	shl	edx, 0
	mov	eax, DWORD PTR _words$25[ebp]
	mov	ecx, DWORD PTR _crc1$15[ebp]
	xor	ecx, DWORD PTR [eax+edx]
	mov	DWORD PTR _word1$5[ebp], ecx
...
; 907  :                 word2 = crc2 ^ words[2];
	...
	shl	edx, 1
	mov	eax, DWORD PTR _words$25[ebp]
	mov	ecx, DWORD PTR _crc2$14[ebp]
	xor	ecx, DWORD PTR [eax+edx]
	mov	DWORD PTR _word2$4[ebp], ecx
...
; 909  :                 word3 = crc3 ^ words[3];
	...
	imul	eax, edx, 3
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc3$13[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	mov	DWORD PTR _word3$3[ebp], edx
...
; 911  :                 word4 = crc4 ^ words[4];
	...
	shl	eax, 2
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc4$12[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	mov	DWORD PTR _word4$2[ebp], edx
...
; 919  :                 words += N;
	...
	mov	DWORD PTR _words$25[ebp], eax
...
; 923  :                 crc0 = crc_braid_big_table[0][word0 & 0xff];
	...
	mov	ecx, 1024				; 00000400H
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _word0$6[ebp]
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc0$16[ebp], ecx
...
; 925  :                 crc1 = crc_braid_big_table[0][word1 & 0xff];
	...
	mov	edx, 1024				; 00000400H
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _word1$5[ebp]
	and	ecx, 255				; 000000ffH
	mov	edx, DWORD PTR _crc_braid_big_table[eax+ecx*4]
	mov	DWORD PTR _crc1$15[ebp], edx
...
; 927  :                 crc2 = crc_braid_big_table[0][word2 & 0xff];
	...
	mov	eax, 1024				; 00000400H
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _word2$4[ebp]
	and	edx, 255				; 000000ffH
	mov	eax, DWORD PTR _crc_braid_big_table[ecx+edx*4]
	mov	DWORD PTR _crc2$14[ebp], eax
...
; 929  :                 crc3 = crc_braid_big_table[0][word3 & 0xff];
	...
	mov	ecx, 1024				; 00000400H
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _word3$3[ebp]
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc3$13[ebp], ecx
...
; 931  :                 crc4 = crc_braid_big_table[0][word4 & 0xff];
	...
	mov	edx, 1024				; 00000400H
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _word4$2[ebp]
	and	ecx, 255				; 000000ffH
	mov	edx, DWORD PTR _crc_braid_big_table[eax+ecx*4]
	mov	DWORD PTR _crc4$12[ebp], edx
...
; 940  :                     crc0 ^= crc_braid_big_table[k][(word0 >> (k << 3)) & 0xff];
	...
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc0$16[ebp]
	xor	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc0$16[ebp], ecx
...
; 942  :                     crc1 ^= crc_braid_big_table[k][(word1 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word1$5[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc1$15[ebp]
	xor	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc1$15[ebp], ecx
...
; 944  :                     crc2 ^= crc_braid_big_table[k][(word2 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word2$4[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc2$14[ebp]
	xor	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc2$14[ebp], ecx
...
; 946  :                     crc3 ^= crc_braid_big_table[k][(word3 >> (k << 3)) & 0xff];
	...
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc3$13[ebp]
	xor	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc3$13[ebp], ecx
...
; 948  :                     crc4 ^= crc_braid_big_table[k][(word4 >> (k << 3)) & 0xff];
	...
	mov	ecx, DWORD PTR _k$24[ebp]
	shl	ecx, 3
	mov	eax, DWORD PTR _word4$2[ebp]
	shr	eax, cl
	and	eax, 255				; 000000ffH
	mov	ecx, DWORD PTR _crc4$12[ebp]
	xor	ecx, DWORD PTR _crc_braid_big_table[edx+eax*4]
	mov	DWORD PTR _crc4$12[ebp], ecx
...
; 963  :             comb = crc_word_big(crc0 ^ words[0]);
	...
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc0$16[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	push	edx
	call	_crc_word_big
	add	esp, 4
	mov	DWORD PTR _comb$23[ebp], eax
...
; 965  :             comb = crc_word_big(crc1 ^ words[1] ^ comb);
	...
	shl	eax, 0
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc1$15[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	xor	edx, DWORD PTR _comb$23[ebp]
	push	edx
	call	_crc_word_big
	add	esp, 4
	mov	DWORD PTR _comb$23[ebp], eax
...
; 967  :             comb = crc_word_big(crc2 ^ words[2] ^ comb);
	...
	shl	eax, 1
	mov	ecx, DWORD PTR _words$25[ebp]
	mov	edx, DWORD PTR _crc2$14[ebp]
	xor	edx, DWORD PTR [ecx+eax]
	xor	edx, DWORD PTR _comb$23[ebp]
	push	edx
	call	_crc_word_big
...
; 969  :             comb = crc_word_big(crc3 ^ words[3] ^ comb);
	...
	imul	ecx, eax, 3
	mov	edx, DWORD PTR _words$25[ebp]
	mov	eax, DWORD PTR _crc3$13[ebp]
	xor	eax, DWORD PTR [edx+ecx]
	xor	eax, DWORD PTR _comb$23[ebp]
	push	eax
	call	_crc_word_big
	add	esp, 4
	mov	DWORD PTR _comb$23[ebp], eax
...
; 971  :             comb = crc_word_big(crc4 ^ words[4] ^ comb);
	...
	shl	ecx, 2
	mov	edx, DWORD PTR _words$25[ebp]
	mov	eax, DWORD PTR _crc4$12[ebp]
	xor	eax, DWORD PTR [edx+ecx]
	xor	eax, DWORD PTR _comb$23[ebp]
	push	eax
	call	_crc_word_big
...
; 980  :             crc = byte_swap(comb);
	...
	mov	edx, DWORD PTR _comb$23[ebp]
	push	edx
	call	_byte_swap
	add	esp, 4
	mov	DWORD PTR _crc$[ebp], eax
...
; 996  :         crc = (crc >> 8) ^ crc_table[(crc ^ *buf++) & 0xff];
	...
	xor	eax, DWORD PTR _crc$[ebp]
	and	eax, 255				; 000000ffH
	xor	ecx, DWORD PTR _crc_table[eax*4]
